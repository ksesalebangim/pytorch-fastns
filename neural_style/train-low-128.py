        ...
        if len(onlysubdir.split("_")) >= 3:
            ...
            for myfile in onlyfiles:
                ...
                if myfile[-4:].lower() == ".jpg":
                    ...
                    command = "python3 neural_style/neural_style.py train --style-image " + inputd + "/" + onlysubdir + "/" + myfile + ".trained --dataset /media/midburn/benson2/fast-neural-style/coco_part/ --content-weight " + \
                                                      arguments[1] + " --style-weight " + arguments[2] + " --batch-size 1 --epochs " + \
                                                      arguments[0] + " --save-model-dir saved-models/" + \
                                                    " --cuda 1 --cudnn-benchmark --log-interval 100 --image-size 128 --vgg-model-dir /media/midburn/benson2/pytorch/pytorch-fastns/vgg/"
                    print(command)
